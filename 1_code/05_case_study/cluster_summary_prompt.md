## Task Description
You will be given a meta-module containing multiple functional modules from different cancers. Your goal is to:
...
- **Consider** shared regulatory mechanisms
...
{"meta-module_name": "Your concise meta-module name here", "summary": "A comprehensive biological summary explaining the meta-module's significance, and potential biological implications"}
...
2. Formulate a name that captures the essence of the meta-module
3. Write a summary that explains the biological story this meta-module tells
