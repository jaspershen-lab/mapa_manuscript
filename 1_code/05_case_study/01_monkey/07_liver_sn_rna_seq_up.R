...
load("liver_up_dt_converted.rda")
...
save(variable_info, file = "liver_up_variable_info.rda")
...
save(enrich_pathway_res,
     file = "liver_up_enrich_pathway_res.rda")
...
save(embedsim_res, file = "liver_up_embedsim_res.rda")
...
save(functional_module_res, file = "liver_up_functional_module_res_biotext.rda")

## Step4: LLM interpretation ====
# setwd("3_data_analysis/05_case_study/01_monkey/")
load("liver_up_functional_module_res_biotext.rda")
...
save(llm_interpreted_fm_res, file = "liver_up_llm_interpreted_fm_res.rda")
...
library(Cairo)
CairoPDF("liver_up_functional_module_network.pdf", width = 12, height = 8)
plot
dev.off()
