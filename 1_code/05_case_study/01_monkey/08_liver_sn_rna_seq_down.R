...
load("liver_down_dt_converted.rda")
...
save(variable_info, file = "liver_down_variable_info.rda")
...
save(enrich_pathway_res,
     file = "liver_down_enrich_pathway_res.rda")
...
save(embedsim_res, file = "liver_down_embedsim_res.rda")

# optimal: louvain 0.84
# load("liver_down_embedsim_res.rda")
...
save(functional_module_res, file = "liver_down_functional_module_res_biotext.rda")
...
save(llm_interpreted_fm_res, file = "liver_down_llm_interpreted_fm_res.rda")
...
library(Cairo)
CairoPDF("liver_down_functional_module_network.pdf", width = 12, height = 8)
plot
dev.off()
