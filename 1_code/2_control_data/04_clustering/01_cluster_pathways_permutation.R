...
mclust::adjustedRandIndex(temp_data$expected_module,
                          as.character(temp_data$hc_result))
...
save(hc_graph_data, file = "hc_graph_data.rda")
...
mclust::adjustedRandIndex(temp_data$expected_module,
                          as.character(temp_data$binary_cut_result))
