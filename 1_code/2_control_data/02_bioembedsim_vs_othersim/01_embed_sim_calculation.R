...
#
# save(all_combined_info, file = "3_data_analysis/02_control_data/02_bioembedsim_vs_othersim/all_combined_info.rda")
# save(all_text_info, file = "3_data_analysis/02_control_data/02_bioembedsim_vs_othersim/all_text_info.rda")

load("3_data_analysis/02_control_data/02_bioembedsim_vs_othersim/all_combined_info.rda")
load("3_data_analysis/02_control_data/02_bioembedsim_vs_othersim/all_text_info.rda")
...
load("3_data_analysis/02_control_data/02_bioembedsim_vs_othersim/embedding_matrix.rda")
